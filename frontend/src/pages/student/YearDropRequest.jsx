            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        disabled={hasDues}
                                        className={`w-full appearance-none bg-slate-950 border border-slate-800 text-white rounded-xl px-4 py-3.5 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-colors cursor-pointer ${hasDues ? 'opacity-50 cursor-not-allowed' : ''}`}
                                        required
                                    >
                        ...
                        {/* Reason Selection */}
                        <div className={`space-y-4 ${hasDues ? 'opacity-50 pointer-events-none' : ''}`}>
                        ...
                        <div className="pt-4">
                            ...
                            >
                                {loading ? (
                                    ...
                                    <>
                                        <span>{hasDues ? 'Clear Dues to Submit' : 'Submit Course Drop Request'}</span>
                                        <Send size={18} />
                                    </>
                                )}
                            </button>
