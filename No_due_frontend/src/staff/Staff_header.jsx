       ...
       <div className="header shadow-sm py-2 px-3" style={{ backgroundColor: "#0d6efd" }}>
          ...
          <div className="d-flex justify-content-between align-items-center text-white">
            ...
            <div className="link-bar d-flex align-items-center gap-2">
              <a href="/staff_dashboard" className="text-decoration-none small text-white">Home</a>
              <a href="/staff_about" className="text-decoration-none small text-white">About</a>
              <a href="/staff_contact" className="text-decoration-none small text-white">Contact</a>
              <a href="/staff_profile" className="text-decoration-none small text-white">Profile</a>
            </div>
          </div>
